...
public class WindowDefaults {
	...
	/**
	 * Whether to limit the GPU to output frames as high as the refresh rate of the monitor.
	 * If enabled it prevents screen tearing but can also introduce minor input lag.
	 */
