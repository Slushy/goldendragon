...
public class TextureLoader {
	...
	public static void loadTexture(Texture texture, String fileName, Texture.TextureOptions textureOptions) throws Exception {
		...
		String pathToFile = ResourceUtils.TEXTURES_PATH + fileName;

		// Parses the file type so we can support multiple types
		switch (ResourceUtils.getFileType(fileName)) {
		case PNG:
			data = decodePNGTexture(ResourceUtils.loadResourceAsStream(pathToFile));
			break;
		default:
